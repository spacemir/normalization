params = {
	...
	#TSODYKS SYN
	"tsodyks_params":{"U":0.5, "u":0.5, "tau_rec":200.0, "tau_fac":0.0},
	...
	"bas_noise_rate":00.0, # [Hz] 5500 brings neuron to rheobase. 4500 weak spontaneous firing, 		1250
	...
	"ipsp_bas_pyr": - 12.0,      #2.6:-1.2mV     -12.0


	"epsp_ext_bas": 0.005,	# 0.009		0.005
	"epsp_pyr_bas": 0.004,	# 0.009		0.004
	"epsp_noise_bas":0.0020,	# 0.0020 5.35 + 4.0
	"ipsp_bas_bas": -0.009,	#NO

	# RANDOMIZED "SIZE" AND START MEMBRANE POTENTIAL used only for randomized versions
	"C_m_mean_pyr": 70.0,
	"C_m_sd_fraction_pyr": 0.25,			# biological value?
	"C_m_mean_bas":7.5,
	"C_m_sd_fraction_bas": 0.25,			# biological value?
	"V_init_mean":  5.0,
	...
	"p_in_bas":0.02,			# input directly to bc. same epsp as from pyramidal
