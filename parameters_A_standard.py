params = {
	...
	"ipsp_bas_pyr": - 2.6,	# -2.6:-1.2mV     -12.0

	"epsp_ext_bas": 0.009,	# 0.009		0.03
	"epsp_pyr_bas": 0.009,	# 0.009		0.004
	...
	"p_in_bas":0.1,			    # input directly to bc. same epsp as from pyramidal
	...
	"random_seeds":[2,7,10,15,16,19,40]   # 2 --> 5.35, 7 --> 4.05, 10 --> 4.65
}
